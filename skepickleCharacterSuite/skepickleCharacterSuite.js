    ...
    source_text_SRD: {
      ...
      spells: {
        ...
        'animal trance': {
          ...
          spell_resistance: 'Yes',
          text:             `Your swaying motions and music (or singing, or chanting) compel animals and magical beasts to do nothing but watch you. Only a creature with an Intelligence score of 1 or 2 can be fascinated by this spell. The closest targets are selected first until no more targets within range can be affected.
        ...
        'arcane mark': {
          ...
          text:             `This spell allows you to inscribe your personal rune or mark, which can consist of no more than six characters. The writing can be visible or invisible. An arcane mark spell enables you to etch the rune upon any substance without harm to the material upon which it is placed. If an invisible mark is made, a [detect magic](http://www.d20srd.org/srd/spells/detectMagic.htm) spell causes it to glow and be visible, though not necessarily understandable.
                             [See invisibility](http://www.d20srd.org/srd/spells/seeInvisibility.htm), [true seeing](http://www.d20srd.org/srd/spells/trueSeeing.htm), a gem of seeing, or a robe of eyes likewise allows the user to see an invisible arcane mark. A [read magic](http://www.d20srd.org/srd/spells/readMagic.htm) spell reveals the words, if any. The mark cannot be dispelled, but it can be removed by the caster or by an [erase](http://www.d20srd.org/srd/spells/erase.htm) spell.
        ...
        'binding': {
          ...
          text:             `A binding spell creates a magical restraint to hold a creature. The target gets an initial saving throw only if its Hit Dice equal at least one-half your caster level.
                             ...
                             *Minimus Containment:* The subject is shrunk to a height of 1 inch or even less and held within some gem, jar, or similar object. The binding is permanent. The subject does not need to breathe, eat, or drink while contained, nor does it age. Reduce the save DC by 4.
                             You can’t dispel a binding spell with [dispel magic](http://www.d20srd.org/srd/spells/dispelMagic.htm) or a similar effect, though an antimagic field or [Mage’s disjunction](http://www.d20srd.org/srd/spells/magesDisjunction.htm) affects it normally. A bound extraplanar creature cannot be sent back to its home plane due to [dismissal](http://www.d20srd.org/srd/spells/dismissal.htm), [banishment](http://www.d20srd.org/srd/spells/banishment.htm), or a similar effect.`,
        ...
        'cause fear': {
          ...
          saving_throw:     'Will partial',
          spell_resistance: 'Yes',
          text:             `The affected creature becomes frightened. If the subject succeeds on a Will save, it is shaken for 1 round. Creatures with 6 or more Hit Dice are immune to this effect.
        ...
        'cloak of chaos': {
          ...
          text:             `A random pattern of color surrounds the subjects, protecting them from attacks, granting them resistance to spells cast by lawful creatures, and causing lawful creatures that strike the subjects to become confused. This abjuration has four effects.
                             ...
                             Finally, if a lawful creature succeeds on a melee attack against a warded creature, the offending attacker is confused for 1 round (Will save negates, as with the [confusion](http://www.d20srd.org/srd/spells/confusion.htm) spell, but against the save DC of cloak of chaos).`,
        ...
        'color spray': {
          ...
          saving_throw:     'Will negates',
          spell_resistance: 'Yes',
          text:             `A vivid cone of clashing colors springs forth from your hand, causing creatures to become stunned, perhaps also blinded, and possibly knocking them unconscious.
        ...
        'contagion': {
          ...
          saving_throw:     'Fortitude negates',
          spell_resistance: 'Yes',
          text:             `The subject contracts a disease selected from the table below, which strikes immediately (no incubation period). The DC noted is for the subsequent saves (use *contagion’s* normal save DC for the initial saving throw).
                             ◦ Disease [DC] Damage
        ...
        'daze': {
          ...
          saving_throw:     'Will negates',
          spell_resistance: 'Yes',
          text:             `This enchantment clouds the mind of a humanoid creature with 4 or fewer Hit Dice so that it takes no actions. Humanoids of 5 or more HD are not affected. A dazed subject is not stunned, so attackers get no special advantage against it.`,
        ...
        'daze monster': {
          ...
          saving_throw:     'Will negates',
          spell_resistance: 'Yes',
          text:             `This enchantment clouds the mind of a living creature with 6 or fewer Hit Dice so that it takes no actions. Creatures of 7 or more HD are not affected. A dazed subject is not stunned, so attackers get no special advantage against it.`,
          component_details:'Material Component: A pinch of wool or similar substance.'
        },
        'death knell': {
        ...
        'heal': {
          ...
          saving_throw:     'Will negates (harmless)',
          spell_resistance: 'Yes (harmless)',
          text:             `*Heal* enables you to channel positive energy into a creature to wipe away injury and afflictions. It immediately ends any and all of the following adverse conditions affecting the Target: [ability damage](https://www.dandwiki.com/wiki/SRD:Ability_Score_Loss#Ability_Damage), blinded, confused, dazed, [dazzled](https://www.dandwiki.com/wiki/SRD:Dazzled), deafened, diseased, [exhausted](https://www.dandwiki.com/wiki/SRD:Exhausted), [fatigued](https://www.dandwiki.com/wiki/SRD:Fatigued), [feebleminded](https://www.dandwiki.com/wiki/SRD:Feeblemind), [insanity](https://www.dandwiki.com/wiki/SRD:Insanity), [nauseated](https://www.dandwiki.com/wiki/SRD:Nauseated), [sickened](https://www.dandwiki.com/wiki/SRD:Sickened), stunned, and [poisoned](https://www.dandwiki.com/wiki/SRD:Poison). It also cures [[10*{?{Caster Level},15}kl1]] hit points of damage.
        ...
        'holy aura': {
          ...
          text:             `A brilliant divine radiance surrounds the subjects, protecting them from attacks, granting them resistance to spells cast by [evil creatures](https://www.dandwiki.com/wiki/SRD:Evil_Subtype), and causing evil creatures to become blinded when they strike the subjects. This abjuration has four effects.
                             ...
                             Finally, if an evil creature succeeds on a melee attack against a warded creature, the offending attacker is blinded (Fortitude save negates, as [blindness/deafness](http://www.d20srd.org/srd/spells/blindnessDeafness.htm), but against *holy aura*’s save DC).`,
        ...
        'holy smite': {
          ...
          text:             `You draw down holy power to smite your enemies. Only evil and neutral creatures are harmed by the spell; good creatures are unaffected.
                             The spell deals [[[[{floor(?{Casting Level}/2),5}kl1]]d8]] points of damage  to each [evil creature](https://www.dandwiki.com/wiki/SRD:Outsider_(evil)) in the area (or [[[[{?{Casting Level},10}kl1]]d6]] points of damage to an [evil outsider](https://www.dandwiki.com/wiki/SRD:Outsider_Type)) and causes it to become blinded for 1 round. A successful Will saving throw reduces damage to half and negates the blinded effect.
        ...
        'instant summons': {
          ...
          text:             `You call some nonliving item from virtually any location directly to your hand.
                             ...
                             The inscription on the gem is invisible. It is also unreadable, except by means of a [read magic](http://www.d20srd.org/srd/spells/readMagic.htm) spell, to anyone but you.
        ...
        'invisibility': {
          ref:              'http://www.d20srd.org/srd/spells/invisibility.htm',
          school:           'Illusion (Glamer)',
        ...
        'magic mouth': {
          ...
          text:             `This spell imbues the chosen object or creature with an enchanted mouth that suddenly appears and speaks its message the next time a specified event occurs. The message, which must be twenty-five or fewer words long, can be in any language known by you and can be delivered over a period of 10 minutes. The mouth cannot utter verbal components, use command words, or activate magical effects. It does, however, move according to the words articulated; if it were placed upon a statue, the mouth of the statue would move and appear to speak. Of course, magic mouth can be placed upon a tree, rock, or any other object or creature.
                             The spell functions when specific conditions are fulfilled according to your command as set in the spell. Commands can be as general or as detailed as desired, although only visual and audible triggers can be used. Triggers react to what appears to be the case. Disguises and illusions can fool them. Normal darkness does not defeat a visual trigger, but magical [darkness](http://www.d20srd.org/srd/spells/darkness.htm) or invisibility does. Silent movement or magical silence defeats audible triggers. Audible triggers can be keyed to general types of noises or to a specific noise or spoken word. Actions can serve as triggers if they are visible or audible. A magic mouth cannot distinguish alignment, level, Hit Dice, or class except by external garb.
        ...
        'nightmare': {
          ...
          text:             `You send a hideous and unsettling phantasmal vision to a specific creature that you name or otherwise specifically designate.
                             ...
                             [Dispel evil](http://www.d20srd.org/srd/spells/dispelEvil.htm) cast on the subject while you are casting the spell dispels the nightmare and causes you to be stunned for 10 minutes per caster level of the [dispel evil](http://www.d20srd.org/srd/spells/dispelEvil.htm).
        ...
        'order\'s wrath': {
          ...
          text:             `You channel lawful power to smite enemies. The power takes the form of a three-dimensional grid of energy. Only chaotic and neutral (not lawful) creatures are harmed by the spell.
                             The spell deals [[[[{floor(?{Casting Level}/2),5}kl1]]d8]] points of damage to chaotic creatures (or [[[[{?{Casting Level},10}kl1]]d6]] points of damage to chaotic outsiders) and causes them to be dazed for 1 round. A successful Will save reduces the damage to half and negates the daze effect.
